...
public class AutoGrantPermissionsAccept 
{
	...
	public void launchChromeBrowser() throws MalformedURLException
	{
		...
		desiredCaps.setCapability("fastReset", Appconstants.fullReset);
		desiredCaps.setCapability("autoGrantPermissions", Appconstants.autoGrantPermissions);
